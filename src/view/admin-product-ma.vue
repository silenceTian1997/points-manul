<template>
  <div class="points-ma">
    ...
    <div class="main">
            <div class="main-item" >
                  <img style="width:1.22rem;" src="../static/images/login/add-i.png" alt="">
            </div>
        <div class="main-item" @click="toContacts">
          <img style="width:2.11rem;" src="../static/images/login/prodeuct-i.png" alt="">
        </div>
    </div>
  </div>
</template>
...
.points-ma{
 ...
 .management-title{
  ...
  .main-item{
    ...
    align-items: center;
    background-color: rgba(210, 54, 2, 0.52);
  }
</style>